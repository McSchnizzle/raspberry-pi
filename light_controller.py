...
LIGHTS = {
    ...
    "kitchen_left": {
        ...
        "system": "tuya",
        "device_id": os.environ.get("TUYA_KITCHEN_LEFT_ID", ""),
        "local_key": os.environ.get("TUYA_KITCHEN_LEFT_KEY", ""),
    ...
    "kitchen_right": {
        ...
        "system": "tuya",
        "device_id": os.environ.get("TUYA_KITCHEN_RIGHT_ID", ""),
        "local_key": os.environ.get("TUYA_KITCHEN_RIGHT_KEY", ""),
